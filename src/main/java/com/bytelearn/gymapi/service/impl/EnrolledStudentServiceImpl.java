    ...
    return enrolledRepository.findAll()
      ...
      .map((EnrolledStudent es) -> {
        return DataEnrolledStudentDTO.builder()
          ...
          .cpf(es.getCpf())
          .email(es.getEmail())
          .plan(DataPlanDTO.builder()
            .id(es.getPlan().getId())
            .description(es.getPlan().getDescription())
            .price(es.getPlan().getPrice())
            .finance(FinanceDTO.builder()
            .id(es.getPlan().getFinance().getId())
            .payday(es.getPlan().getFinance().getPayday())
            .planMonths(es.getPlan().getFinance().getPlanMonths())
            .dueDate(es.getPlan().getFinance().getDueDate())
            .build())
          .build())
